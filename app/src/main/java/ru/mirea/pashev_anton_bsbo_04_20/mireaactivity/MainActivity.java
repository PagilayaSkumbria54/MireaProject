...
import ru.mirea.pashev_anton_bsbo_04_20.mireaactivity.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void getResult(View view){
        EditText inputexample = (EditText) findViewById(R.id.editTextTextPersonName);
        int res = 0;
